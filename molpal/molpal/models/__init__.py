...
def model(model: str, **kwargs) -> Model:
    ...
    if model == "chemberta":
        from molpal.models.chemberta import ChemBERTa
        kwargs.pop("input_size", None)
        return ChemBERTa(**kwargs)
    
    if model == "gin":
        from molpal.models.gin import GINVirtual

        kwargs.pop("input_size", None)
        kwargs.pop("config", None)
        return GINVirtual(**kwargs)
    
    if model == "molformer":
        from molpal.models.molformer import MolFormerAl

        kwargs.pop("input_size", None)
        kwargs.pop("config", None)
        return MolFormerAl(**kwargs)
